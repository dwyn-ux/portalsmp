...
<section style="background:#065f46" class="pt-14 texture-noise texture-lines relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="flex items-center justify-between py-4" style="border-bottom:1px solid rgba(255,255,255,0.1)">
            <span style="background:#fbbf24;color:#064e3b;font-size:10px;letter-spacing:0.1em;text-transform:uppercase;font-weight:700;padding:4px 10px">Portal Digital Sekolah</span>
            <span style="background:rgba(255,255,255,0.1);color:rgba(255,255,255,0.6);font-size:10px;letter-spacing:0.1em;text-transform:uppercase;font-weight:600;padding:4px 10px">Sistem Terintegrasi</span>
        </div>

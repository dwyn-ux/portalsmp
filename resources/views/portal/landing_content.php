    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14">
            <div class="flex items-center gap-3">
                ...
                <span class="font-bold text-gray-900 text-sm">SMP Muhammadiyah Unggulan Ashidiq</span>
            </div>
            <a href="#apps" class="text-sm text-gray-500 hover:text-gray-900 font-medium transition hidden sm:block">Aplikasi</a>
        </div>
    </div>
</nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
                ...
                <div class="lg:col-span-5 lg:flex lg:items-end">
                    <div style="width:100%">
                        ...
                        <div style="display:flex;align-items:baseline;gap:12px;<?= $i > 0 ? 'border-top:1px solid rgba(255,255,255,0.06);' : '' ?>padding:16px 0">
                            ...
                            <span style="color:#555;font-size:12px;letter-spacing:0.1em;text-transform:uppercase;font-weight:500">
                                <?= $stat['label'] ?>
                            </span>
                        </div>
                        <?php endforeach; ?>
...
<div x-data="{ open: true }" x-show="open" x-cloak
    ...
    <div class="bg-white max-w-md w-full" style="max-height:80vh;overflow:hidden"
         x-transition:enter="transition ease-out duration-200"
            ...
            <div class="flex flex-col sm:flex-row gap-3 mb-8">
                <div class="relative flex-1">
                    ...
                    <input type="text" x-model="search" placeholder="Cari..."
                           style="width:100%;padding:10px 12px 10px 36px;border:1px solid #e5e7eb;font-size:14px;outline:none;transition:border-color 0.2s"
...
<footer style="background:#1a1a1a;padding:48px 0" class="texture-lines">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <p style="font-size:11px;letter-spacing:0.1em;text-transform:uppercase;color:#555;margin-bottom:12px;font-weight:600">Tautan</p>
                <a href="/" style="font-size:13px;color:#888;text-decoration:none;transition:color 0.2s" onmouseover="this.style.color='#10b981'" onmouseout="this.style.color='#888'">Portal Utama</a>
            </div>
            <div>
                <p style="font-size:11px;letter-spacing:0.1em;text-transform:uppercase;color:#555;margin-bottom:12px;font-weight:600">Kontak</p>
                <?php if (!empty($settings['school_email'])): ?>
                <p style="font-size:13px;color:#888;margin-bottom:4px"><?= \App\Helpers\H::e($settings['school_email']) ?></p>
                <?php endif; ?>
                <?php if (!empty($settings['school_phone'])): ?>
                <p style="font-size:13px;color:#888"><?= \App\Helpers\H::e($settings['school_phone']) ?></p>
                <?php endif; ?>
            </div>
        </div>
        <div style="border-top:1px solid rgba(255,255,255,0.06);margin-top:32px;padding-top:24px;text-align:center">
            <p style="font-size:11px;color:#444"><?= \App\Helpers\H::e($settings['footer_text'] ?? '© 2025 SMP Muhammadiyah Unggulan Ashidiq.') ?></p>
        </div>
    </div>
</footer>

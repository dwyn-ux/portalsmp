...
$heroBgStyle = !empty($heroBg)
    ? "background: linear-gradient(170deg, rgba(255,255,255,0.85), rgba(255,255,255,0.85)), url('".\App\Helpers\H::e($heroBg)."') no-repeat center center fixed; background-size:cover;"
    : '';
?>
<style>
.portal-bg {
